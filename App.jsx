...
import { Ban, BarChart3, BookOpen, Calendar, Check, ClipboardList, Dumbbell, Eye, Megaphone, Moon, NotebookPen, Pencil, Play, Power, Settings, Stethoscope, Sun, Target, Trash2, TrendingUp, X } from "lucide-react";
import { actualizarAdmin, actualizarRolAdmin, cambiarPINAlumno, cargarBiblioteca, cargarBioimpedanciaCompleta, cargarCatalogoCached, cargarDatos, cargarFotos, cargarNovedades, cargarPesos, cargarPlanesXDia, cerrarSesionAuth, crearAdmin, crearAlumnoConPIN, crearNovedad, crearPlanAlumno, deleteAlumno, desactivarAdmin, eliminarNovedad, eliminarPlanDia, getPrepGlobales, guardarDatos, guardarEjercicioBiblioteca, guardarFotoAlumno, guardarPeriodizacionDia, listarAdmins, listarPeriodizacionesConNombres, listarVariantesPlan, payloadAlumno, propagarEjercicioATodos, saveDailyAttendance, saveDailyWeight, subirMediaRehab, supabase, toggleNovedad } from "./services/supabase.js";
...
import { AsignarPlanModal } from "./src/screens/AsignarPlanModal.jsx";
import { BibliotecaScreen } from "./src/screens/BibliotecaScreen.jsx";
...
import { DiarioAdmin } from "./src/screens/DiarioAdmin.jsx";
import { HistorialAdmin } from "./src/screens/HistorialAdmin.jsx";
import { Login } from "./src/screens/Login.jsx";
import { NovedadesAdmin } from "./src/screens/NovedadesAdmin.jsx";
import { NovedadesAlumno } from "./src/screens/NovedadesAlumno.jsx";
import { PlanesPrincipales } from "./src/screens/PlanesPrincipales.jsx";
import { ReportesAlumno } from "./src/screens/ReportesAlumno.jsx";
import { ORDEN_DIAS, RM_EJS, calcularEdad, diasDeTodosLosPlanes, ejerciciosDeTodosLosPlanes, getSemanaActual, hoy, initH, initPesos, mesActual, registroAsistencia, unirHistorialesPorEjercicio } from "./src/utils/helpers.js";
...
import { clonarPlan, getPlantilla } from "./src/utils/planTemplates.js";
...
import { FONT_BODY, FONT_DISPLAY, S, TAP, TS, applyTheme, card, chipN4, eyebrow, innerCard, inp, n4Track, segChip, segTrack, smallBtn, tabN1, useIsWide } from "./src/utils/theme.js";
