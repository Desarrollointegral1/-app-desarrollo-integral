...
export const S = {...DARK_T};
export const card = {background:S.card,border:"1px solid "+S.border,borderRadius:10};
export const inp = {background:S.card2,border:"1px solid "+S.border,borderRadius:6,padding:"9px 12px",color:S.white,fontSize:14,outline:"none",width:"100%",boxSizing:"border-box"};
...
export function applyTheme(dark) {
  ...
  Object.assign(S,t);
  Object.assign(card,{background:S.card,border:"1px solid "+S.border,borderRadius:10});
  Object.assign(inp,{background:S.card2,border:"1px solid "+S.border,borderRadius:6,padding:"9px 12px",color:S.white,fontSize:14,outline:"none",width:"100%",boxSizing:"border-box"});
}
